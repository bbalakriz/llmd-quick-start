...
## Deploy the llmd-test namespace
...
```sh
oc get llminferenceservice -n llmd-test
...
curl -s -X POST http://${INFERENCE_URL}/llmd-test/${LLM_SVC}/v1/completions \
