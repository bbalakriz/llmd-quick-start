...
**Example Attack:**
- Legitimate service: `llmd-test/my-model` creates HTTPRoute with prefix `/llmd-test/my-model`
- Attacker in `evil-ns` creates HTTPRoute with prefix `/llmd-test/my-model/v1/chat/completions`
            ...
            matchExpressions:
              - key: kubernetes.io/metadata.name
                ...
                values:
                  ...
                  - llmd-test  # Add your namespaces here
```
...
curl -s http://${INFERENCE_URL}/llmd-test/my-model/v1/models \
